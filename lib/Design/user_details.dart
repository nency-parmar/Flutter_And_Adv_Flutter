...
class _UserDetailsState extends State<UserDetails> {
  ...
  void initState() {
    super.initState();
    _isFavorite = widget.user['isFavorite'] == 1; // ✅ Corrected
  }
  ...
  void _toggleFavorite() {
    ...
    // Convert bool back to int for database update (if required)
    int favoriteValue = _isFavorite ? 1 : 0;

    // Update the database if needed
    print("User ${widget.user['name']} favorite status: $favoriteValue");
